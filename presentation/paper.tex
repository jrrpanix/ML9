...
In our research, we found that reducing the number of features through combining documents for each FOMC meeting into one and increasing Ngram size had an impact on accuracy for most of our models. However, while it improved the performance of Naive Bayes, the net effect (as measured in F1 score) was lower precision and accuracy.  \vertSpace
