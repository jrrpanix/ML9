...
if __name__ == '__main__':
    ...
    parser.add_argument('--IterLoop', help='this is for plotting the stDev', default = 20)
    ...
    parser.add_argument('--outputFileName', default = 'data_multiple_iterations.csv')
    ...
    outputDF.to_csv('../text/data_for_graphs/'+outputFileName, index=False, header=["Model Name", "NGram", "Niter", "mean(acc)", "std(acc)","N","PctTrain", "clean", "start", "end", "Data Sets", "TrainP", "TestP", "Prec", "Recall", "F1", "Stack"])
