...
\begin{figure}[h!]
  \includegraphics[width=\linewidth]{../output/analysis/unstacked-nb-ll.JPG}
...
Overall our research found that Logistic Lasso with $\alpha = 0.002$ produced the most stable results for predicting FOMC rate decisions from FOMC statements, minutes, and Board of Governors speeches.
