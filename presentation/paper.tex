...
\begin{subfigure}{.5\textwidth}
  \centering
\includegraphics[height=2in,width=2in]{../text/data_for_graphs/accuracy.pdf}
\caption{Accuracy peaks at around 10 iterations}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
\includegraphics[height=2in,width=2in]{../text/data_for_graphs/F1.pdf}
  \caption{A subfigure}
  \label{fig:sub2}
\end{subfigure}
\caption{F1 also peaks at around 10 iterations}
\label{fig:test}
\end{figure}
