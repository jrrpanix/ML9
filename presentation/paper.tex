...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/log_lass_accuracy_more iterations".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/log_reg_accuracy_more iterations".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/NB_accuracy_more iterations".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/SVM_accuracy_more iterations".pdf}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/log_lasso_f1".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/log_f1".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/naive_bayes_f1".pdf}
\includegraphics[width=.3\textwidth]{"../text/data_for_graphs/SVM_f1".pdf}
\end{center}
\end{figure}
