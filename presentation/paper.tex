...
\begin{enumerate}
 ...
 \item We test the accuracy of ML models trained on FOMC statements and a percentage of FOMC minutes on a test set of FOMC minutes
 \item We create a predictive model that is trained on documents that are temporally released before the test document.  Typically we will test with FOMC minutes releases or Board of Governor speeches.  
\end{enumerate}
...
When we train the model with statements and minutes, ten statements will be considered one document because of the magnitude of minute size to statement size.  
